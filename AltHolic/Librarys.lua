...
elseif Turbine.Engine.GetLanguage() == Turbine.Language.French then
	...
	-- English is the safe fallback for any client language without a dedicated localization.
...
import "Homeopatix.AltHolic.Core";
...
import "Homeopatix.AltHolic.GenderWindow";
