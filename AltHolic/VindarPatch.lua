...
function PatchDataLoad(a,b,c)
	...
	if success then
		...
		if success then
			...
			Write("Error:"..tostring(results))
			Write("While processing convBack(Turbine.PluginData.Load("..tostring(a)..", "..tostring(b)..", "..tostring(c).."))")
			return nil;
		end
	else
		Write("Error:"..tostring(results))
		Write("While processing Turbine.PluginData.Load("..tostring(a)..", "..tostring(b)..", "..tostring(c)..")")
		return nil;
	end
end
