...
function CreateUIShowWallet(namePlayerToshow)
	...
	local buttonClose;
	local centerWindow = {};
	local centerWindowName = {};
	local ButtonPlusCash = {};
	local centerLabelCash = {};
	local centerLabelCash2 = {};
	local centerLabelCash3 = {};
	local centerLabelCash4 = {};
	local itemTmp2;
	local itemTmp4;
	...
	-- Sort slot keys directly so duplicate wallet entries remain distinct.
	local newtable = AltHolicUtil.SortedItemSlots(PlayerWallet[namePlayerToshow] or {});
